...
class SalaryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Filter berdasarkan Branch (Cabang)
    ...
    /**
     * ============================================================
     * CREATE (Hanya Karyawan Aktif & Tidak Resign)
     * ============================================================
     */
...
/**
     * ============================================================
     * GENERATE / RE-SYNC MONTHLY SALARIES
     * ============================================================
     */
    ...
    /**
     * ============================================================
     * RESET PAYROLL PERIODE BULAN TERPILIH
     * ============================================================
     */
    public function resetMonthlySalaries(Request $request)
    {
        ...
        $user = Auth::user();
        $query = Salary::whereBetween('created_at', [
            $startDate->format('Y-m-d H:i:s'),
            $endDate->format('Y-m-d H:i:s'),
        ]);
        ...
        return redirect()
            ...
            ->with('success', "Berhasil mereset {$deletedCount} data payroll untuk periode {$month}/{$year}.");
    }
    /**
     * ============================================================
     * EXPORT EXCEL
