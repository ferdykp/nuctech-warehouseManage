...
@section('content')
                    ...
                    <select name="employee_id" id="employee_select"
                        ...
                        @foreach ($employees as $emp)
                            @php
                                ...
                                $calculatedInfo = method_exists($emp, 'getCalculatedSalaryInformation')
                                    ? $emp->getCalculatedSalaryInformation()
                                    : 'regular salary';
                            @endphp
    ...
    @push('scripts')
        <script>
            ...
            function initCreateSalaryScripts() {
                const amountDisplay = document.getElementById('amount_display');
                const amountReal = document.getElementById('amount_real_input');
            ...
            document.addEventListener('DOMContentLoaded', initCreateSalaryScripts);

            if (window.up) {
                up.on('up:fragment:inserted', function() {
                    initCreateSalaryScripts();
                });
            }
        </script>
    @endpush
