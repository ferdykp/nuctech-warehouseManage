...
@section('content')
    {{-- Inisialisasi data dengan Alpine.js --}}
    <div class="min-h-screen px-6 py-6" x-data="{
        ...
        {{-- Tombol submit aktif jika password kosong (tidak ganti) ATAU password diisi dan match --}}
        isValid() {
        ...
        <div class="p-6 mb-6 bg-white shadow-lg rounded-2xl">
            <div class="flex items-center gap-4">
                <div class="p-3 bg-blue-100 rounded-lg">
                    <i class="text-xl text-blue-600 fa-solid fa-user-gear"></i>
                </div>
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Edit User Account</h1>
                    <p class="text-sm text-gray-500">Update account details for <span
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700">
                            New Password
                            <span class="text-xs font-normal leading-none text-gray-400">(Leave blank to keep
                                current)</span>
                        </label>
                        <div class="relative">
