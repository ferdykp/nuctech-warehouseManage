                ...
                <table id="datatable" class="min-w-full overflow-hidden border border-gray-200 rounded-lg">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-sm font-semibold text-center text-gray-600">Code Site</th>
                            <th class="px-4 py-3 text-sm font-semibold text-center text-gray-600">Machine Name</th>
                            <th class="px-4 py-3 text-sm font-semibold text-center text-gray-600">Machine Type</th>
                            <th class="px-4 py-3 text-sm font-semibold text-center text-gray-600">Is Active</th>
                            <th class="px-4 py-3 text-sm font-semibold text-center text-gray-600">Action</th>
                        </tr>
                    </thead>

                    <tbody class="divide-y">
                        @forelse ($site as $index => $site)
