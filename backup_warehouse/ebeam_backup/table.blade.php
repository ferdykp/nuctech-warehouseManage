    ...
    <tr class="border-b hover:bg-gray-50">
        ...
        <td class="px-4 py-3">
            <div class="flex justify-center gap-2">
                ...
                @if (Auth::user()->role === 'admin')
                    <a href="{{ route('ebeam.edit', $item->id) }}"
                        ...
                        <div x-show="open" x-cloak x-transition.opacity
                            ...
                            <div @click.outside="open = false" x-transition
                                ...
                                <div class="flex justify-end gap-3">
                                    ...
                                    <form action="{{ route('ebeam.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="grid grid-cols-1 gap-6 p-6 md:grid-cols-2">
            ...
            <div class="space-y-4 text-sm text-gray-700">
                ...
                <div>
                    ...
                    <p class="font-semibold" id="d_created_at"></p>
                </div>

                <div>
                    <p class="text-xs text-gray-500">Last Updated</p>
                    <p class="font-semibold" id="d_updated_at"></p>
                </div>
...
<script>
    function openDetailModal(item) {
        ...
        // timestamps ✅
        document.getElementById('d_created_at').innerText = formatDateTime(item.created_at);
        document.getElementById('d_updated_at').innerText = formatDateTime(item.updated_at);
