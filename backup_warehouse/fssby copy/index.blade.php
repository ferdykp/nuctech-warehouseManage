        ...
        <div class="bg-white shadow-lg rounded-2xl">
            ...
            <div class="px-6 py-4 border-b">
                <h4 class="text-xl font-semibold text-gray-800">
                    List Sparepart FS6000 Surabaya
                </h4>
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-3 mb-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @if (Auth::user()->role === 'admin')
                            ...
                            <a href="{{ route('fssby.exportExcel') }}"
                    ...
                    <div class="w-full md:w-72">
                        <input type="text" id="search" name="search" data-route="{{ route('fssby.search') }}"
                ...
                <div class="flex flex-col gap-3 mt-4 md:flex-row md:items-center md:justify-between">
                    <div class="text-sm text-gray-600">
                        Showing {{ $fs6000sbys->firstItem() }} to {{ $fs6000sbys->lastItem() }} of
                        {{ $fs6000sbys->total() }} entries
                    </div>
