        ...
        <div class="overflow-hidden bg-white shadow-2xl rounded-2xl">
            ...
            <div class="px-8 py-6 border-b bg-gray-50">
                <h4 class="text-2xl font-bold text-gray-800">
                    Tambah Sparepart FS6000 Jakarta
                </h4>
                <p class="mt-1 text-sm text-gray-500">
                    Form input data sparepart untuk lokasi Jakarta
                </p>
            ...
            {{-- BODY --}}
            <div class="px-8">
                <form action="{{ route('fsjkt.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
