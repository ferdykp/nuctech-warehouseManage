            ...
            <div class="p-6">
                ...
                <div class="flex flex-col gap-3 mb-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @if (Auth::user()->role === 'admin')
                            ...
                            <a href="{{ route('fsjkt.exportExcel') }}"
                    ...
                    <div class="w-full md:w-72">
                        <input type="text" id="search" name="search" data-route="{{ route('fsjkt.search') }}"
                ...
                <div class="overflow-x-auto border rounded-xl">
                    <table class="w-full text-sm border-collapse">
                        ...
                        {{-- <tbody id="table-body" class="divide-y">
                            @include('fsjkt.table', ['data' => $fs6000jkts])
                        </tbody> --}}
                        <tbody id="table-body">
                            @include('fsjkt.table', [
                                'data' => $fs6000jkts,
                ...
                <div class="flex flex-col gap-3 mt-4 md:flex-row md:items-center md:justify-between">
                    <div class="text-sm text-gray-600">
                        Showing {{ $fs6000jkts->firstItem() }} to {{ $fs6000jkts->lastItem() }} of
                        {{ $fs6000jkts->total() }} entries
                    </div>
